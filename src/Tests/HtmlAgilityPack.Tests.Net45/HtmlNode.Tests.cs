...
<style>NOTSEE style</style></div>
        ...
        public void checkAttributForTextComment()
        {
            ...
            HtmlNode div = doc.GetElementbyId("foo") as HtmlNode;
            int count = 0;
            ...
            foreach (var childNode in div.ChildNodes)
            {
                try
                {
                    HtmlNode textNode = childNode as HtmlNode;
                    textNode.Id = "1";
                    count++;
                }
                catch (Exception e)
        ...
        {
            HtmlNode source = HtmlNodeFactory.CreateNode(@"
<ul>
  <li> Alpha   </li>
  <li> Bravo   </li>
  <li> Charlie </li>
...
") as HtmlNode;
            HtmlNode destination = HtmlNodeFactory.CreateNode(@"
<ul>
  <li> Delta   </li>
  <li> Echo    </li>
  <li> Foxtrot </li>
